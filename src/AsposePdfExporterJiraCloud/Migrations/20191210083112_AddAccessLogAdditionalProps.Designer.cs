...
namespace Aspose.Cloud.Marketplace.App.JiraCloud.Pdf.Exporter.Migrations
{
    ...
    [Migration("20191210083112_AddAccessLogAdditionalProps")]
    partial class AddAccessLogAdditionalProps
    {
            ...
            modelBuilder.Entity("AsposePdfExporter.Model.AccessLog", b =>
                {
                    ...
                    b.Property<DateTime?>("Finished")
                        ...
                        .HasColumnType("timestamp")
                        .HasComment("finish time");

                    b.Property<string>("Message")
                        .HasColumnName("message")
                        .HasColumnType("text")
                        .HasComment("custom message");

                    b.Property<int?>("Seconds")
                        .HasColumnName("passed_sec")
                        .HasColumnType("integer")
                        .HasComment("process request seconds");

                    b.Property<string>("Stat")
                        .HasColumnName("stats")
                        .HasColumnType("text")
                        .HasComment("statistics json");
